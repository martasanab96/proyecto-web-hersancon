...
export const data = [
    {
        ...
        price: 1000,
        quantity: 1,
        detail: "La instalación de paneles solares debe ser realizada por un instalador profesional y capacitado, para garantizar una instalación segura y eficiente. Además, la instalación puede variar dependiendo de la ubicación geográfica, el tipo de techo y otros factores específicos de cada hogar. En general, la instalación de paneles solares en una casa típica sigue los siguientes pasos: Evaluación del sitio: Antes de la obra se lleva a cabo una evaluación del sitio para determinar si la casa es adecuada para la instalación de paneles solares. Se evalúa la orientación y la inclinación del techo, la sombra y la cantidad de espacio disponible para la instalación de los paneles. En Naturgy te ofrecemos una visita gratuita y sin compromiso de nuestros instaladores para evaluar la adecuación de tu oferta a las condiciones de tu vivienda.  Obtención de permisos: Antes de la instalación, se deben obtener los permisos necesarios del gobierno local y/o de la compañía eléctrica.  Preparación del sitio e instalación de los paneles solares: Primero se prepara el sitio para la obra. Cuando está todo listo se instalan los paneles solares y se conectan los cables del sistema a un inversor, que convierte la energía solar en energía utilizable para el hogar.   Conexión a la red eléctrica: Por último, se conecta el sistema solar a la red eléctrica de la casa, lo que permite que la energía generada por los paneles solares se utilice directamente en el hogar y/o se venda a la red eléctrica para obtener créditos o retribución económica.",
        reseñas: [
